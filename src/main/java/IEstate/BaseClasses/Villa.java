...
public class Villa implements IEstate {

    private final float listPrice;
    private final float minimumSellingPrice;
    private final LocalDate dateOfConstruction;
    private final String address;
    private final String descrition = "Villa";

    public Villa(float listPrice, float minimumSellingPrice, LocalDate dateOfConstruction, String address) {
